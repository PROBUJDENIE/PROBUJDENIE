...
export function ConfirmModalDelSection({modalState, changeModalState, onConfirm, courseId}) {
    if (modalState !== 27) return null;
    ...
    return (
        <div className="modal-overlay" onClick={handleCancel}>
            <div className="modal-block-del" onClick={e => e.stopPropagation()}>
                <Logo ></Logo>
                <div className="modal-block_title"> Удалить главу?</div>
