        ...
        <>
            <div className="bottom">
                ...
                <div className="bottom-btns">
                    <CommonBtn leftIcon={<img src={teleg} width={50} height={50}/>} width={370} height={40} size={22} borderColor={"#8A6CFF"} fontColor={333333} onClick={() => window.open("https://web.telegram.org/a/#1133165164", "_blank") }>@V_BELIKOV_V</CommonBtn>
                    <CommonBtn leftIcon={<img src={mail} width={50} height={50}/>} width={370} height={40} size={22} borderColor={"#8A6CFF"} fontColor={333333} onClick={() => window.open("https://web.telegram.org/a/#1133165164", "_blank") }>probujdenie@mail.ru</CommonBtn>
                </div>
