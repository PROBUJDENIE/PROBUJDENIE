...
export function ConfirmModalSaveCourse({modalState, changeModalState, onConfirm, courseId}) {
    if (modalState !== 21) return null;
    ...
    return (
        <div className="modal-overlay" onClick={handleCancel}>
            <div className="modal-block-save" onClick={e => e.stopPropagation()}>
                <Logo ></Logo>
                <div className="modal-block_title"> Сохранить курс?</div>
