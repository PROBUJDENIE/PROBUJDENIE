...
export function ConfirmModalDelTask({modalState, changeModalState, onConfirm, courseId}) {
    if (modalState !== 24) return null;
    ...
    return (
        <div className="modal-overlay" onClick={handleCancel}>
            <div className="modal-block-del" onClick={e => e.stopPropagation()}>
                <Logo ></Logo>
                <div className="modal-block_title"> Удалить задание?</div>
